...
const NetStats = require('./Node/NetStats');
const NodeServer = require('./Node/NodeServer');
...
class NodeStatus extends Abstract {
  constructor(data) {
    ...
    this[P_TIMESTAMP] = parseInt(data.locked, 10);
    ...
    this[P_OPENSSL] = ByteCollection.fromHex(data.openssl);
